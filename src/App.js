      ...
      >
        <g id="large">
          <g>
            ...
            />
            <animateTransform>
              attributeName="transform" begin="0s" dur="3s" type="rotate"
        ...
        <g id="small">
          ...
          />
          <animateTransform>
            attributeName="transform" begin="0s" dur="2s" type="rotate" from="0
            78 21" to="-360 78 21" repeatCount="indefinite"
          </animateTransform>
        </g>
      </svg>
      <p>
